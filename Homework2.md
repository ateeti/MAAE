...
-The t test for $\beta_2$ is $T_{\hat{\beta_2}} = {\hat{\beta_2} - 1 / se(\hat{\beta_2}) =  0.8426563 - 1 / 0.0920169 \approx -1.71$

-------------------------------------------------------

<strong>C11</strong>. Use the data in HTV to answer this question.
